...
import icoUser from "../Components/img/ico-user.png";
import icoWeb from "../Components/img/ico-web.png";
import icoBlockchain from "../Components/img/ico-blockchain.png";
import icoTitle from "../Components/img/title.png";
