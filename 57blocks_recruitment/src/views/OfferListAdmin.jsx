...
const OfferListAdmin = () => {
    ...
    const handleDelete = (job) => {
        ...
        //confirmar acción
        axios.delete(`https://stormy-river-28303.herokuapp.com/api/v1/jobs/${job.id}`)
            .then((res) => {
    ...
    return (
        ...
        <>
            <div style={{display:"flex",justifyContent:"end",marginTop:50, marginRight: 110}}>
                <Button sx={{textTransform:'capitalize', marginX: 5, backgroundColor:"#2B7BF4"}} variant="contained" onClick={handleClick}>
                    + Create new job
                </Button>
            </div>
                    ...
                    >
                        <CardContent>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'center', marginTop: "3rem", marginX: 5 }}>
                                ...
                                {/* <OfferButtons textContent= "View"/>
                            <OfferButtons textContent= "Edit"/>
                            <OfferButtons textContent= "Delete"/> */}
                            </div>
                        </CardContent>
